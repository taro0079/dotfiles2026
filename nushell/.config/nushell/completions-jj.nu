module completions {
  ...
  export extern jj [
    --repository(-R): directory # Path to repository to operate on
  ...
  export extern "jj absorb" [
    ...
    --interactive(-i)         # Interactively choose which parts to absorb
  ...
  export extern "jj bisect run" [
    --range(-r): string       # Range of revisions to bisect (can be repeated)
    ...
    --config-file: path       # Additional configuration files (can be repeated)
    --help(-h)                # Print help (see more with '--help')
    command?: string          # Command to run to determine the status of a revision
  ...
  export extern "jj bookmark track" [
    ...
    --config-file: path       # Additional configuration files (can be repeated)
    --help(-h)                # Print help (see more with '--help')
    ...names: string          # Bookmark name patterns or remote bookmark symbols to track
  ]
  ...
  export extern "jj bookmark untrack" [
    ...
    --config-file: path       # Additional configuration files (can be repeated)
    --help(-h)                # Print help (see more with '--help')
    ...names: string          # Bookmark name patterns or remote bookmark symbols to untrack
  ]
  ...
  export extern "jj config gc" [
    ...
    --at-op: string           # Operation to load the repo at
    --debug                   # Enable debug logging
    --color: string@"nu-complete jj config gc color" # When to colorize output
    --quiet                   # Silence non-primary command output
    --no-pager                # Disable the pager
    --config: string          # Additional configuration options (can be repeated)
    --config-file: path       # Additional configuration files (can be repeated)
  ...
  def "nu-complete jj converge color" [] {
    [ "always" "never" "debug" "auto" ]
  }

  # Converge divergent changes
  export extern "jj converge" [
    --revision(-r): string    # The search space to look for divergent revisions
    --no-interactive          # Do not prompt the user for help resolving divergence
    --interactive(-i)         # No-op flag to pair with --no-interactive
    --repository(-R): directory # Path to repository to operate on
    --ignore-working-copy     # Don't snapshot the working copy, and don't update it
    --no-integrate-operation  # Run the command as usual but don't integrate any operations
    --ignore-immutable        # Allow rewriting immutable commits
    ...
    --at-op: string           # Operation to load the repo at
    --debug                   # Enable debug logging
    --color: string@"nu-complete jj converge color" # When to colorize output
    --quiet                   # Silence non-primary command output
    --no-pager                # Disable the pager
    --config: string          # Additional configuration options (can be repeated)
    --config-file: path       # Additional configuration files (can be repeated)
  ...
  export extern "jj debug stacked-table" [
    ...
    --config-file: path       # Additional configuration files (can be repeated)
    --help(-h)                # Print help (see more with '--help')
    dir: directory            # Path to table store directory
  ]
  ...
  export extern "jj evolog" [
    ...
    --no-graph(-G)            # Show a flat list of revisions instead of a graph
  ...
  export extern "jj file search" [
    ...
    --line-number(-n)         # Prefix each matched line with its 1-based line number within the file
    --repository(-R): directory # Path to repository to operate on
    --ignore-working-copy     # Don't snapshot the working copy, and don't update it
    --no-integrate-operation  # Run the command as usual but don't integrate any operations
    --ignore-immutable        # Allow rewriting immutable commits
  ...
  export extern "jj gerrit upload" [
    --revision(-r): string    # The revisions to upload to Gerrit
    --remote-branch(-b): string # The location where your changes are intended to land
    --remote: string          # The Gerrit remote to push to
    --dry-run(-n)             # Only display what will change on the remote; do not push changes to Gerrit
    ...
    --topic: string           # Apply a topic to the change
    --hashtag: string         # Apply a hashtag to the change (can be repeated)
    --message(-m): string     # The description for the patch set
    ...
    --option(-o): string      # Send a `git push -o` option (can be repeated)
  ...
  def "nu-complete jj git clone object_hash" [] {
    [ "sha1" "sha256" ]
  }
  ...
  export extern "jj git clone" [
    ...
    --object-hash: string@"nu-complete jj git clone object_hash" # Object hash algorithm for the local Git repository
    --repository(-R): directory # Path to repository to operate on
    --ignore-working-copy     # Don't snapshot the working copy, and don't update it
    --no-integrate-operation  # Run the command as usual but don't integrate any operations
    --ignore-immutable        # Allow rewriting immutable commits
    ...
    destination?: directory   # Specifies the target directory for the Jujutsu repository clone. If not provided, defaults to a directory named after the last component of the source URL. The full directory path will be created if it doesn't exist
  ]
  ...
  export extern "jj git fetch" [
    ...
    --tag(-t): string         # Fetch only some of the tags (can be repeated)
    --tracked                 # Fetch only tracked bookmarks and tags
  ...
  def "nu-complete jj git init object_hash" [] {
    [ "sha1" "sha256" ]
  }
  ...
  export extern "jj git init" [
    --colocate                # Colocate the Jujutsu repo with the git repo
    --no-colocate             # Disable colocation of the Jujutsu repo with the git repo
    --object-hash: string@"nu-complete jj git init object_hash" # Object hash algorithm for the newly created Git repository
    --git-repo: directory     # Specifies a path to an **existing** git repository to be used as the backing git repo for the newly created `jj` repo
    --repository(-R): directory # Path to repository to operate on
    --ignore-working-copy     # Don't snapshot the working copy, and don't update it
    --no-integrate-operation  # Run the command as usual but don't integrate any operations
    --ignore-immutable        # Allow rewriting immutable commits
    ...
    --config-file: path       # Additional configuration files (can be repeated)
    --help(-h)                # Print help (see more with '--help')
    destination?: directory   # The destination directory where the `jj` repo will be created. If the directory does not exist, it will be created. If no directory is given, the current directory is used
  ]
  ...
  export extern "jj git push" [
    ...
    --deleted                 # Push all deleted bookmarks and tags
    ...
    --revision(-r): string    # Push bookmarks and tags pointing to these commits (can be repeated)
  ...
  export extern "jj operation diff" [
    ...
    --no-graph(-G)            # Show a flat list of modified changes instead of a graph
  ...
  export extern "jj operation log" [
    ...
    --no-graph(-G)            # Show a flat list of operations instead of a graph
  ...
  export extern "jj rebase" [
    ...
    --destination: string     # The revision(s) to rebase onto (can be repeated to create a merge commit)
  ...
  export extern "jj run" [
    ...
    --jobs(-j): string        # How many processes should run in parallel
    ...
    --ignore-changes          # Run the command without rewriting any commits
    ...
    --config-file: path       # Additional configuration files (can be repeated)
    --help(-h)                # Print help (see more with '--help')
    command: string           # Command to run across all selected revisions
    ...args: string           # Arguments to pass to the command
  ]
  ...
  def "nu-complete jj tag track color" [] {
    [ "always" "never" "debug" "auto" ]
  }

  # Start tracking given remote tags
  export extern "jj tag track" [
    --remote: string          # Remote names to track
    --repository(-R): directory # Path to repository to operate on
    --ignore-working-copy     # Don't snapshot the working copy, and don't update it
    --no-integrate-operation  # Run the command as usual but don't integrate any operations
    ...
    --at-op: string           # Operation to load the repo at
    --debug                   # Enable debug logging
    --color: string@"nu-complete jj tag track color" # When to colorize output
    --quiet                   # Silence non-primary command output
    --no-pager                # Disable the pager
    --config: string          # Additional configuration options (can be repeated)
    --config-file: path       # Additional configuration files (can be repeated)
    --help(-h)                # Print help (see more with '--help')
    ...names: string          # Tag name patterns or remote tag symbols to track
  ]

  def "nu-complete jj tag untrack color" [] {
    [ "always" "never" "debug" "auto" ]
  }

  # Stop tracking given remote tags
  export extern "jj tag untrack" [
    --remote: string          # Remote names to untrack
    --repository(-R): directory # Path to repository to operate on
    --ignore-working-copy     # Don't snapshot the working copy, and don't update it
    --no-integrate-operation  # Run the command as usual but don't integrate any operations
    ...
    --at-op: string           # Operation to load the repo at
    --debug                   # Enable debug logging
    --color: string@"nu-complete jj tag untrack color" # When to colorize output
    --quiet                   # Silence non-primary command output
    --no-pager                # Disable the pager
    --config: string          # Additional configuration options (can be repeated)
    --config-file: path       # Additional configuration files (can be repeated)
    --help(-h)                # Print help (see more with '--help')
    ...names: string          # Tag name patterns or remote tag symbols to untrack
  ]
  ...
  export extern "jj workspace add" [
    ...
    --config-file: path       # Additional configuration files (can be repeated)
    --help(-h)                # Print help (see more with '--help')
    destination: directory    # Where to create the new workspace
  ]
